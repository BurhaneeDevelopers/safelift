...
export const components = {
  ...
  block: {
    ...
    h2: ({ children }) => <h2 className="my-10 text-3xl">{children}</h2>,
    h3: ({ children }) => <h3 className="my-5 text-2xl">{children}</h3>,
    h4: ({ children }) => <h4 className="my-4 text-xl">{children}</h4>,
    h5: ({ children }) => <h5 className="my-4 text-lg">{children}</h5>,
    h6: ({ children }) => <h6 className="my-4 text-md">{children}</h6>,
    blockquote: ({ children }) => (
