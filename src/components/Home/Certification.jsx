...
const Card = ({ index, title, content, className }) => {
  return (
    ...
    >
      <div className="bg-[#00aeef] p-3 6xl:py-5 pl-14 px-10 2xl:px-7 6xl:pl-16 flex justify-center items-end 4xl:items-center rounded-e-full translate-y-7 relative">
